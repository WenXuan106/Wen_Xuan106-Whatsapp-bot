...
function startTelegramBot() {
  ...
  // taking the WhatsApp bot down with it. Telegram must never be able
  // to do that; log and continue instead.
  bot.launch().catch((err) => {
    console.error("Telegram bot failed to start (WhatsApp is unaffected):", err.message);
  });
