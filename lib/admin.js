...
/**
 * True if `msg` was sent by the bot owner — either the bot's own linked
 * WhatsApp account (fromMe, e.g. you messaging your own bot), or a
 * number explicitly configured as OWNER_NUMBER in config.js/env for
 * owner-only commands like !stop. This is a separate concept from group
 * admin status above: "owns this bot" vs. "is an admin of this group".
 */
