...
async function getGroupAdminStatus(sock, groupJid, msg, fetchMetadata) {
  ...
  const senderCandidates = await withAltJids(sock, getSenderCandidates(msg));
...
module.exports = { getGroupAdminStatus, getMentionedJid, getQuotedParticipant, resolveParticipantId };
